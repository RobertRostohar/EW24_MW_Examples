...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    PP9     ------> XSPIM_P1_IO9
    */
    GPIO_InitStruct.Pin = HEXASPI_DQS1_Pin|HEXASPI_DQS0_Pin|HEXASPI_CLK_Pin|HEXASPI_NCS1_Pin;
  ...
  */
    ...
    PN5     ------> XSPIM_P2_IO3
    */
    GPIO_InitStruct.Pin = OCTOSPI_NCS1_Pin|OCTOSPI_IO1_Pin|OCTOSPI_DQS_Pin|OCTOSPI_IO7_Pin
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  /* USER CODE END XSPI1_MspDeInit 0 */
    ...
    PP9     ------> XSPIM_P1_IO9
    */
    HAL_GPIO_DeInit(GPIOO, HEXASPI_DQS1_Pin|HEXASPI_DQS0_Pin|HEXASPI_CLK_Pin|HEXASPI_NCS1_Pin);
  ...
  /* USER CODE END XSPI2_MspDeInit 0 */
    ...
    PN5     ------> XSPIM_P2_IO3
    */
    HAL_GPIO_DeInit(GPION, OCTOSPI_NCS1_Pin|OCTOSPI_IO1_Pin|OCTOSPI_DQS_Pin|OCTOSPI_IO7_Pin
                          |OCTOSPI_IO6_Pin|OCTOSPI_IO5_Pin|OCTOSPI_IO0_Pin|OCTOSPI_CLK_Pin
                          |OCTOSPI_IO4_Pin|OCTOSPI_IO2_Pin|OCTOSPI_IO3_Pin);

...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* heth)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, ETH_MDIO_Pin|RMII_REF_CLK_Pin|RMII_CRS_DV_Pin);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    PJ4     ------> LTDC_R5
    */
    HAL_GPIO_DeInit(GPIOK, LCD_B6_Pin|LCD_B5_Pin|LCD_B7_Pin|LCD_B4_Pin
                          |LCD_DE_Pin|LCD_G7_Pin|LCD_G5_Pin|LCD_G6_Pin);

    HAL_GPIO_DeInit(GPIOJ, LCD_B3_Pin|LCD_B2_Pin|LCD_B0_Pin|LCD_B1_Pin
                          |LCD_G4_Pin|LCd_G3_Pin|LCD_G2_Pin|LCD_R1_Pin
                          |LCD_G1_Pin|LCD_G0_Pin|LCD_R7_Pin|LCD_R2_Pin
                          |LCD_R6_Pin|LCD_R3_Pin|LCD_R4_Pin|LCD_R5_Pin);

    HAL_GPIO_DeInit(GPIOI, LCD_HSYNC_Pin|LCD_VSYNC_Pin|LCD_CLK_Pin|LCD_R0_Pin);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA11     ------> USB_OTG_FS_DM
    */
    HAL_GPIO_DeInit(GPIOA, USB_FS1_ID_Pin|VBUS_FS1_Pin|USB_FS1_DP_Pin|USB_FS1_DM_Pin);

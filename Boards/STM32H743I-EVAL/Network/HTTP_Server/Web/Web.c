...
/* Last-Modified: Thu, 28 Mar 2024 12:04:08 GMT */
const uint32_t imageLastModified = 1711627448U;

static const uint8_t imageFileData[25959U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0x69E9F01DU, &imageFileData[13805U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[15056U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15700U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18516U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19905U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[21043U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22830U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25838U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25959U] }
};
